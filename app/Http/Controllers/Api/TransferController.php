        ...
        if ($params['id']) {
            ...
            if ($resutl) {
                ...
                if ($transfer_old->acc_bank_from_id != $params['acc_bank_from_id']) {
                    ...
                    }elseif ($bank_from_old->type == "STAFF") {
                    ...
                    }elseif ($bank_from_new->type == "STAFF") {
