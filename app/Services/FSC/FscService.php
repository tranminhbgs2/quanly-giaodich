...
class FscService
{
    ...
    public function getSchools()
    {
        ...
        $input = [
            ...
            "partnercode" => Constants::FSC_PARTNER_CODE,
            "data" => $data_base64_encode,
            "signature" => $sign
        ];

        $res_str = sendRequest(Constants::FSC_BILLGW_URL, $input, 'POST', true, false, null, 120);
    ...
    public function findStudent($params)
    {
        ...
        if ($student_name) {
            ...
            $res_str = sendRequest(Constants::FSC_BILLGW_URL, $input, 'POST', true, false, null, 60);
